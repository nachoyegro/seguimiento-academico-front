...
class GraficoDeDispersion extends CustomChart {
  ...
  renderChart(data) {
    ...
    >
      <CartesianGrid />
      <XAxis type="number" dataKey={this.props.dataX} name={this.props.nombreX} unit={this.props.unitX} domain={[0, 10]} />
      <YAxis type="number" dataKey={this.props.dataY} name={this.props.nombreY} unit={this.props.unitY} domain={[0, 10]} />
